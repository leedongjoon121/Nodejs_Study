...
// Express의 미들웨어 불러오기
var bodyParser = require('body-parser')  // 파일 업로드시 post 방식으로 전송
...
// 파일 업로드용 미들웨어
var multer = require('multer');  // 멀터 미들웨어!!!!
var fs = require('fs');   // 파일을 업로드 후 업로드한 파일을 다뤄야 하는 경우가 많으므로 fs모듈도 함께 사용
